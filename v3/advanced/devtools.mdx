...
Install Inertia DevTools from the [Chrome Web Store](http://todo), or download the latest release from [GitHub](https://github.com/inertiajs/inertia-devtools/releases) and load it unpacked.
