...
Arrow function components assigned directly to `.layout` are not supported. Inertia cannot reliably distinguish them from render functions at runtime. Wrapping the component in an array resolves this:
