...
In React, arrow function components should be wrapped in an array. Without the array, Inertia cannot distinguish them from render functions at runtime. See the [upgrade guide](/v3/getting-started/upgrade-guide#react-arrow-function-layout-components) for details.
